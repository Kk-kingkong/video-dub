...
PACKAGE_NAME = "LocalTube-Dub-Engine-v0.2.3-Windows-x64.zip"
CHECKSUM_NAME = "LocalTube-Dub-v0.2.3-Windows-x64-SHA256SUMS.txt"
ENGINE_FOLDER = "LocalTube-Dub-Engine-v0.2.3-Windows-x64"
