...
WINDOWS_PACKAGE_NAME = "LocalTube-Dub-Engine-v0.2.1-Windows-x64.zip"
WINDOWS_CHECKSUM_NAME = "LocalTube-Dub-v0.2.1-Windows-x64-SHA256SUMS.txt"
WINDOWS_TEMPLATES = {
...
def verify_install_smoke(package: Path) -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="LocalTube Dub 测试 ") as temporary:
        ...
        try:
            ...
            require(health["engineVersion"] == "0.2.1", "wrong Engine version accepted")
