...
> **Status:** `0.2.1` release candidate. The Chrome Web Store update is pending; optional desktop Engine packages remain unsigned and unnotarized development builds.
