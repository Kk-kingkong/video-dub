...
- The customer-authorized installer clears only its own Engine directory's download quarantine and then runs the existing complete runtime-lock and installed-tree verification before activation.
